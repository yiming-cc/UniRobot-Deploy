...
from .processor_xvla_client import G1DataProcessor
...
class XVLAClientPolicy(PreTrainedPolicy):

    config_class = XVLAClientConfig
    name = "xvla_client"
    ...
    def select_action(self, batch: dict[str, Tensor]) -> Tensor:
        ...
        action[13] = 1.0 if action[13] > 0.5 else 0.0
