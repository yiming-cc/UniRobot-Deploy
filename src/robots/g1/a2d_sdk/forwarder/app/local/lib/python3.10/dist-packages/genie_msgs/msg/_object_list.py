...
class Metaclass_ObjectList(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from genie_msgs.msg import Object
...
class ObjectList(metaclass=Metaclass_ObjectList):
    ...
    _fields_and_field_types = {
        ...
        'objects': 'sequence<genie_msgs/Object>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['builtin_interfaces', 'msg'], 'Time'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['genie_msgs', 'msg'], 'Object')),  # noqa: E501
    )
