...
bool genie_msgs__msg__scene_request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("genie_msgs.msg._scene_request.SceneRequest", full_classname_dest, 42) == 0);
  }
  genie_msgs__msg__SceneRequest * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of SceneRequest */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("genie_msgs.msg._scene_request");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SceneRequest");
