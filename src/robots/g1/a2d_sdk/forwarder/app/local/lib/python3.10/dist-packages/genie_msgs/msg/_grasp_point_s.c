...
bool genie_msgs__msg__grasp_point__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("genie_msgs.msg._grasp_point.GraspPoint", full_classname_dest, 38) == 0);
  }
  genie_msgs__msg__GraspPoint * ros_message = _ros_message;
  {  // pos
  ...
  {  // direction
    ...
    if (!genie_msgs__msg__Point3D__Sequence__init(&(ros_message->direction), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create genie_msgs__msg__Point3D__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    genie_msgs__msg__Point3D * dest = ros_message->direction.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!genie_msgs__msg__point3_d__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
  ...
  {  // in_plane_rotation
    PyObject * field = PyObject_GetAttrString(_pymsg, "in_plane_rotation");
    if (!field) {
      return false;
    }
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'in_plane_rotation'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    ...
    if (!genie_msgs__msg__Point3D__Sequence__init(&(ros_message->in_plane_rotation), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create genie_msgs__msg__Point3D__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    genie_msgs__msg__Point3D * dest = ros_message->in_plane_rotation.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!genie_msgs__msg__point3_d__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of GraspPoint */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("genie_msgs.msg._grasp_point");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GraspPoint");
  ...
  {  // in_plane_rotation
    PyObject * field = NULL;
    size_t size = ros_message->in_plane_rotation.size;
    field = PyList_New(size);
    if (!field) {
      return NULL;
    }
    genie_msgs__msg__Point3D * item;
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->in_plane_rotation.data[i]);
      PyObject * pyitem = genie_msgs__msg__point3_d__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
    ...
    assert(PySequence_Check(field));
    {
      int rc = PyObject_SetAttrString(_pymessage, "in_plane_rotation", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
