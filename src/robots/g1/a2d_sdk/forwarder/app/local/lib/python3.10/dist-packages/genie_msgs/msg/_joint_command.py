    ...
    def mode(self, value):
        ...
        if __debug__:
            ...
            assert \
                ...
                "The 'mode' field must be a set or sequence and each value of type 'int' and each unsigned integer in [0, 4294967295]"
