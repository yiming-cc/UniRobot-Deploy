...
class Metaclass_FaultStatus(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from genie_msgs.msg import FaultDescription
            if FaultDescription.__class__._TYPE_SUPPORT is None:
                FaultDescription.__class__.__import_type_support__()
...
class FaultStatus(metaclass=Metaclass_FaultStatus):
    ...
    _fields_and_field_types = {
        ...
        'faults': 'sequence<genie_msgs/FaultDescription>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['genie_msgs', 'msg'], 'FaultDescription')),  # noqa: E501
    )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, FaultDescription) for v in value) and
                 True), \
                "The 'faults' field must be a set or sequence and each value of type 'FaultDescription'"
        self._faults = value
