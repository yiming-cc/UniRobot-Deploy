...
bool genie_msgs__msg__end_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("genie_msgs.msg._end_state.EndState", full_classname_dest, 34) == 0);
  }
  genie_msgs__msg__EndState * ros_message = _ros_message;
  {  // header
  ...
  {  // controlled
    PyObject * field = PyObject_GetAttrString(_pymsg, "controlled");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->controlled = (Py_True == field);
    Py_DECREF(field);
  }
  {  // type
  ...
  {  // end_state
    ...
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'end_state'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    ...
    if (!genie_msgs__msg__MotorState__Sequence__init(&(ros_message->end_state), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create genie_msgs__msg__MotorState__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    genie_msgs__msg__MotorState * dest = ros_message->end_state.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
...
{
  /* NOTE(esteve): Call constructor of EndState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("genie_msgs.msg._end_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "EndState");
  ...
  {  // controlled
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->controlled ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "controlled", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // end_state
    PyObject * field = NULL;
    size_t size = ros_message->end_state.size;
    field = PyList_New(size);
    if (!field) {
      return NULL;
    }
    ...
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->end_state.data[i]);
