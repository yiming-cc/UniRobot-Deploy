...
bool genie_msgs__msg__reactive_control__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("genie_msgs.msg._reactive_control.ReactiveControl", full_classname_dest, 48) == 0);
  }
  genie_msgs__msg__ReactiveControl * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of ReactiveControl */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("genie_msgs.msg._reactive_control");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ReactiveControl");
