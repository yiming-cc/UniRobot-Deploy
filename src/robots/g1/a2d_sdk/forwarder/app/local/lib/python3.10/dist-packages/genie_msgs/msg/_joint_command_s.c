...
// with input from genie_msgs:msg/JointCommand.idl
...
bool genie_msgs__msg__joint_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("genie_msgs.msg._joint_command.JointCommand", full_classname_dest, 42) == 0);
  }
  genie_msgs__msg__JointCommand * ros_message = _ros_message;
  {  // header
...
PyObject * genie_msgs__msg__joint_command__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("genie_msgs.msg._joint_command");
