...
bool genie_msgs__msg__waist_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("genie_msgs.msg._waist_state.WaistState", full_classname_dest, 38) == 0);
  }
  genie_msgs__msg__WaistState * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of WaistState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("genie_msgs.msg._waist_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "WaistState");
