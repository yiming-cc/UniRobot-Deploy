...
class JointState(metaclass=Metaclass_JointState):
    ...
    def __init__(self, **kwargs):
        ...
        self.motor_current = array.array('d', kwargs.get('motor_current', []))
    ...
    def motor_current(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'd', \
                "The 'motor_current' array.array() must have the type code of 'd'"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, float) for v in value) and
                 all(not (val < -1.7976931348623157e+308 or val > 1.7976931348623157e+308) or math.isinf(val) for val in value)), \
                "The 'motor_current' field must be a set or sequence and each value of type 'float' and each double in [-.000000, .000000]"
        self._motor_current = array.array('d', value)
