...
bool genie_msgs__msg__mocap_joint_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("genie_msgs.msg._mocap_joint_state.MocapJointState", full_classname_dest, 49) == 0);
  }
  genie_msgs__msg__MocapJointState * ros_message = _ros_message;
  {  // name
...
{
  /* NOTE(esteve): Call constructor of MocapJointState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("genie_msgs.msg._mocap_joint_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MocapJointState");
