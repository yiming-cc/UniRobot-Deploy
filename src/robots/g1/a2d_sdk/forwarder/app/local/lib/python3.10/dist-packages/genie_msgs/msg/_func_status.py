...
class Metaclass_FuncStatus(type):
    """Metaclass of message 'FuncStatus'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'genie_msgs.msg.FuncStatus')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__func_status
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__func_status
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__func_status
            cls._TYPE_SUPPORT = module.type_support_msg__msg__func_status
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__func_status
...
class FuncStatus(metaclass=Metaclass_FuncStatus):
    """Message class 'FuncStatus'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.func_status = kwargs.get('func_status', int())
    ...
    def __eq__(self, other):
        ...
        if self.header != other.header:
            return False
        if self.func_status != other.func_status:
            return False
    ...
    def func_status(self):
        """Message field 'func_status'."""
        return self._func_status

    @func_status.setter
    def func_status(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'func_status' field must be of type 'int'"
            assert value >= 0 and value < 4294967296, \
                "The 'func_status' field must be an unsigned integer in [0, 4294967295]"
        self._func_status = value
    ...
    def publish_ptp_ts(self, value):
        if __debug__:
            ...
            assert value >= 0 and value < 4294967296, \
                "The 'publish_ptp_ts' field must be an unsigned integer in [0, 4294967295]"
    ...
    def publish_ts(self, value):
        if __debug__:
            ...
            assert value >= 0 and value < 4294967296, \
                "The 'publish_ts' field must be an unsigned integer in [0, 4294967295]"
